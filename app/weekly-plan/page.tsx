...
export const metadata: Metadata = {
  title: "Shopify Practice Weekly Plan — Royal Cyber",
};
    ...
    <div className="mx-auto max-w-6xl px-6 py-8">
      <div className="mb-5">
        ...
        <h1 className="mt-1 text-2xl font-extrabold text-sh-dark">
          {weeklyPlan.org} — Shopify Practice Weekly Plan
        </h1>
        <p className="mt-1 text-sm text-sh-muted">
          Generated: {weeklyPlan.generated} · {weeklyPlan.weeks.length} weeks · Jul–Dec 2026 GTM execution
        </p>
      </div>
